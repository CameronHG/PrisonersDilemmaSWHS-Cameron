...
def move(my_history, their_history, my_score, their_score, opponent_name):
    if my_score < -700:
        ...
        if (prior_round_me == shark) and \
            ...
            return 'c'
    elif '5' or '6' or '4' in opponent_name and their_history[-1] == 'b':
        return 'c'
    elif their_score < -400 and their_score > -750:
        return 'c'
    elif 'Ethan' in opponent_name and len(their_history) > 5 and their_history[-1] == 'b':
        return 'b'
    elif 'HHHHHHH' in opponent_name and my_history[-1] == 'c':
        return 'b'
